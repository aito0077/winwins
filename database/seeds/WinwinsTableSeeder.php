...
class WinwinsTableSeeder extends Seeder {
    ...
    public function run() {
        ...
        $winwin->published = 1;
        $winwin->selected = 1;
        $winwin->closing_date= '2015-11-30'; 
        $winwin->save();
        ...
        $winwin->what_happen = "En la temporada, la playa del delfín, se llena con cosas (botellas plástico, papeles, etc.)que los vecinos y turistas van dejando, pero también algunas que trae el mar. Es feo, pero se puede solucionar, y eso mejoraría no sólo la imagen de";
        $winwin->description= "";
